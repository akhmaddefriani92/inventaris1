    ...
    <section class="content">
      ...
      <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><b>Data Keseluruhan Table Users</b></h3>
            </div>
	        <div class="box-body">


      <a class='btn btn-primary btn-sm' href='#myModal'  data-toggle='modal' >Add User</a>
      <br/><br/>
        <!--modal -->
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class='row'>
            ...
            foreach ($data as $key => $row) {
             ...
             $kota = $dbfunc->get_kota($row["id_kota"]);
             $kode_kota = $kota["kode_kota"];
             echo "<td>$kode_kota</td>";
      		   echo "<td><a class='btn btn-primary btn-xs'href='#myModal2' id='custId' data-toggle='modal' data-id='$row[id_user]'>edit</a>  <a href='#' id='$row[id_user]' class='btn btn-danger btn-xs hapus'>hapus</a>
      				</td>";
...
<script>
  $(document).on('click', " tr td .hapus", function() {
    ...
    //if (sa == true) {
    $.post('delete_user.php', {id:del_id},function(data){
