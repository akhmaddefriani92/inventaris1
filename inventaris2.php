      ...
      ?>	  
        <div class="row">
          ...
          <div class="col-md-3 ">
            ...
            <div class="col-md-2 ">
              <br/>
              <button type="submit" name="submit_kota" class="btn btn-primary">Submit </button>
            </div>  
            </form>
          <?php
          }
          ...
          <table class="table table-hover table-bordered" id="view_table" style="font-size:small;">
              ...
              if($kode_kota=="ALL"){
                  ...
                  if(isset($_POST["submit_kota"])){
                     ...
                     $data = $dbfunc->list_inventaris_post_kota($post_kota);
                  }
                  /*
                  else{
                ...
                $data  = $dbfunc->list_inventaris_daerah($kode_kota);
              }  
