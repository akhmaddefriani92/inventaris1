    ...
    <section class="content">
      ...
      <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><b>Data Keseluruhan Table Master Barang</b></h3>
            </div>
	        <div class="box-body">


      <a class='btn btn-primary btn-sm' href='#myModal'  data-toggle='modal' >Add Master Barang</a>
      <br/><br/>
        <!--modal -->
    <div class="modal fade" id="myModal" role="dialog">
      <div class="modal-dialog" role="document">
        <form action="insert_master_barang.php" class="form-horizontal" method="POST" >
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3" for="UserName">Data Perangkat:</label>
                    <div class="col-sm-9">
                      <input type="text" name="data_perangkat" class="form-control" >
                    </div>
              </div>

              <div class="form-group">
                <label class="control-label col-sm-3" for="UserName">Merk:</label>
                    <div class="col-sm-9">
      	  ...
      	  <table class="table table-hover" id="view_table">
              ...
              <tbody>
              <?php
             $data = $dbfunc->list_master_barang();
            ...
            foreach ($data as $key => $row) {
             ...
             echo "<tr id='tr'>";
      		  ...
      		  # echo "<td>".md5($row["password"])."</td>";
      		   ...
      		   echo "<td><a class='btn btn-primary btn-xs'href='#myModal2' id='custId' data-toggle='modal' data-id='$row[id_barang]'>edit</a>  <a href='#' id='$row[id_barang]' class='btn btn-danger btn-xs hapus'>hapus</a>
      				</td>";
...
<div class="modal fade" id="myModal2" role="dialog">
    ...
    <div class="modal-dialog" role="document">
        <form action="update_master_barang.php" method="post" class="form-horizontal">
		<div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
  ...
  $(function() {
   $("#datepicker ").datepicker({
    ...
    $('#myModal2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'POST',
            url : 'fetch_master_barang.php', //Here you will fetch records 
...
<script>
  $(document).on('click', " tr td .hapus", function() {
    ...
    //if (sa == true) {
    $.post('delete_master_barang.php', {id:del_id},function(data){
    //parent.slideUp('slow', function() {
    //$(this).remove();
     //$("#view_table").html(del_id);
    $(location).attr('href', 'master_barang.php');
    //})
     });
   //} 
});
