    ...
    <section class="content">
      ...
      <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><b>Manage Menu </b></h3>
            </div>
	        <div class="box-body">
            
             <a class='btn btn-primary btn-sm' href='#myModal'  data-toggle='modal' >Add Menu</a>
      <br/><br/>
        <!--modal -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class='row'>
                  <div class='col-md-6'>
                    <label>Menu</label> 
                    <input type='text' class='form-control' name='navi_menu' />
                   </div>
            ...
            foreach ($data as $key => $row) {
             ...
             echo "<tr id='tr'>";
      		   ...
      		   echo "<td>$row[navi_link]</td>";
      		   echo "<td>".$row["active"]."</td>";
      		   
      		   echo "<td><a class='btn btn-primary btn-xs'href='#myModal2' id='custId' data-toggle='modal' data-id='$row[id_menu]'>edit</a>  <a href='#' id='$row[id_menu]' class='btn btn-danger btn-xs hapus'>hapus</a>
      				</td>";
  ...
  $(function() {
   $("#datepicker ").datepicker({
    ...
    $('#myModal2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'POST',
            url : 'fetch_menu.php', //Here you will fetch records 
...
<script>
  $(document).on('click', " tr td .hapus", function() {
    ...
    //if (sa == true) {
    $.post('delete_menu.php', {id:del_id},function(data){
    //parent.slideUp('slow', function() {
    //$(this).remove();
     //$("#view_table").html(del_id);
    $(location).attr('href', 'manage-menu.php');
    //})
     });
   //} 
});
