    ...
    <section class="content">
      ...
      <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><b>Manage Kota </b></h3>
            </div>
	        <div class="box-body">
            
             <a class='btn btn-primary btn-sm' href='#myModal'  data-toggle='modal' >Add Kota</a>
      <br/><br/>
        <!--modal -->
      ...
      <div class="modal-dialog" role="document">
        <form action="insert_kota.php" method="POST" >
          <div class="modal-content">
      	  ...
      	  <table class="table table-hover table-bordered" id="view_table">
            ...
            foreach ($data as $key => $row) {
             ...
             echo "<td>$row[alamat]</td>";
      		   echo "<td><a title='edit' class='btn btn-primary btn-xs'href='#myModal2' id='custId' data-toggle='modal' data-id='$row[id_kota]'><i  class='fa fa-pencil' aria-hidden='true'></i></a> 
      				</td>";
             #<a href='#' title='hapus' id='$row[id_kota]' class='btn btn-danger btn-xs hapus'><i class='fa fa-trash' aria-hidden='true'></i></a>
      		   echo "</tr>";
      		  $key++;
            }
...
<div class="modal fade" id="myModal2" role="dialog">
    ...
    <div class="modal-dialog" role="document">
        <form action="update-kota.php" method="post" >
		<div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
  ...
  $(function() {
   $("#datepicker ").datepicker({
    ...
    $('#myModal2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'POST',
            url : 'fetch_kota.php', //Here you will fetch records 
...
<script>
  $(document).on('click', " tr td .hapus", function() {
    ...
    //if (sa == true) {
    $.post('delete_kota.php', {id:del_id},function(data){
    //parent.slideUp('slow', function() {
    //$(this).remove();
     //$("#view_table").html(del_id);
    $(location).attr('href', 'kota.php');
    //})
     });
   //} 
});
